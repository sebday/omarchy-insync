...
BarWidget {
  ...
  function showFloating() {
    if (panelLoader.item && panelLoader.item.showFloating) panelLoader.item.showFloating()
  }
  ...
  readonly property string tooltip: panelLoader.item ? panelLoader.item.barTooltip : "Insync"
